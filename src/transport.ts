...
export class AppServerTransport {
  ...
  private async launch() {
    ...
    try {
      await this.sendRequest('initialize', { clientInfo: { name: 'codex_component', title: 'Codex Component', version: '0.1.0' }, capabilities: { experimentalApi: this.options.experimental ?? false } });
